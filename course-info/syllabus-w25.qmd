...
# Dates of Exams
exam_dates <- c(ymd(20250212), 
                ymd(20250315)
                )
finals_week <- seq(ymd(20250317), ymd(20250321), by = 1)
project_dates <- ymd(20250319)
...
project_days <- Cal |> 
  ...
  rowwise() |> 
  mutate(Date = paste(format(date, "%b %e"), sep = ",", collapse = ", "))
...
Cal2 <- tibble(date = seq(ymd(20240107), ymd(20240113), by = 1))  |> 
  mutate(mon      = lubridate::month(date, label = T, abbr = F),
         ...
         officehrtime = c(NA, NA, "1:00-2:00pm",NA,  "10:00-\n11:00am", "12:00-1:00pm", NA)
  )
...
conceptual questions, please use the course [Discord page](https://support.discord.com/hc/en-us/articles/360033931551-Getting-Started) (you will join
this Week 1). If you have a question – someone else in class does too! I
encourage you all to respond to each other. I will check Discord at
least twice each weekday during working hours (8-6) to ensure that
questions are being answered accurately.

I encourage you to give your post a concise and informative initial
sentence, so that other people can find it. For example, *“How do I
color bars in a barplot with ggplot?”* is a better opening sentence than
*“help with plotting”*.

You may post snippets of your code and errors on Discord, but please do
not post full solutions to lab assignments.

`r fontawesome::fa("brain")` While your posts are not anonymous, in this
case there is no such thing as a bad question!
...
-   Section 70: 12:10am - 2:00pm
-   Section 71: 2:10pm - 4:00pm
...
#| fig-height: 3.5
#| fig-pos: 'h'
#| fig-cap: "Note: Tuesday, January 21st will follow a Monday class schedule."
class_cal
```
...
::: callout-tip
## **Final Exam** Saturday March 15th 1:10 - 4:00 pm

The final exam will take place Sat 3/15 from 1:10-4:00 pm in 42-0205E. If you have a conflict with the common final time, please communicate this to me as soon as possible and by the end of Week 8 at the latest.
:::
...
efforts. Note that the Canvas Check-in quizzes can be submitted two two
times and your highest score will be kept, so you should get close to
100% on this part of the course!

-   Check-ins are (typically) due **Mondays at 12:00pm**.

#### Practice Activities

Most Monday's, you will be given a Practice Activity to complete, to get
...
-   Practice Activities are (typically) due **Wednesdays at 12:00pm.**
...
-   Labs are due on **Saturdays at 11:59pm**.
...
not "round up" grades at the end of the quarter, but it is possible that
I could lower any of the grade cutoffs. <!-- ::: column-margin -->
...
This course will rely heavily on in-class group work. You will be assigned groups throughout the course and will be expected to work with your
group on in-class material. If you have concerns about random group assignment, please
