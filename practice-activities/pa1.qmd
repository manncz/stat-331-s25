...
2. If you have already [installed R, RStudio, and Quarto](https://manncz.github.io/stat331-calpoly-text/01-introduction.html#checkin3-install), you can download the [practice activity template](../student-versions/pas/pa1.qmd) here.
